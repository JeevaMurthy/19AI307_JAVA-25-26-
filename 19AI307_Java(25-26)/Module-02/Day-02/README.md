...
## ALGORITHM :
Step 1: Define a class demo with two methods:

- square(int n) → returns n * n.
- cube(int n) → returns n * square(n) by calling the square() method internally.

Step 2: In the main class, read an integer input from the user.

Step 3: Create an object of the demo class.

Step 4: Call the cube() method using the object and print the result.
