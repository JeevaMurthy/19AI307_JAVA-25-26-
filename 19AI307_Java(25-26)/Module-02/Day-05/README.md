...
## ALGORITHM :
Step 1: Create a class Employee with a variable name.

Step 2: Write a method setName() to assign value to name.

Step 3: Write a method display() that returns the current object using return this;.

Step 4: Write a method printName() to print the employee name.

Step 5: Add another method show() that internally calls display().printName().

Step 6: In the main() method, read the employee name from the user.

Step 7: Create an Employee object and set the name.

Step 8: Call both display().printName() and show() to demonstrate method chaining.
