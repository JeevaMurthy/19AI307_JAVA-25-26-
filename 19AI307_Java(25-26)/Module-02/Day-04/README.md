...
Step 1: Define a class Student with two instance variables:

- String name

- int age

Step 2: Create a parameterized constructor to initialize these variables.

Step 3: Override the toString() method to return the student details in a formatted string.
...
Step 5: Print the object, which automatically calls the overridden toString() method.
