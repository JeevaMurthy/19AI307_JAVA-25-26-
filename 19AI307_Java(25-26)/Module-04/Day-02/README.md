...
Step 3: Create a PrintSpooler class with:
- A private static instance.
- A private constructor.
- A public static getInstance() method to return the single instance.

Step 4: Maintain a counter that represents the number of print jobs.
Step 5: In the main() method, simulate two departments submitting print jobs.
Step 6: Access the same instance of the Print Spooler and increment the job count.
Step 7: Display the print job queue.
