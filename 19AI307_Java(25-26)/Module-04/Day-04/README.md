...
Step 2:Import the necessary package 'java.util'
Step 3: Create a Shape interface containing a draw() method.
Step 4: Create concrete classes Circle, Square, and Rectangle implementing Shape.
Step 5: Create a ShapeFactory class with a method getShape(String shapeType).
Step 6: In the main() method, accept user input for shape type.
Step 7: Call factory method to get the appropriate object.
Step 8: Draw the shape or print error if unknown.
