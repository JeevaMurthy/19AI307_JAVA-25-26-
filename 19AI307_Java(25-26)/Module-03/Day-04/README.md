...
## ALGORITHM :
Step 1:	Create WeatherBot interface with predict() method.
Step 2:	Implement SunBot and RainBot classes with different prediction logic.
Step 3:	Take temperature and botType as input.
Step 4:	Use the chosen bot to call predict().
